...
class PcdData(ModelNet40Data):
    def __init__(
        ...
        super(ModelNet40Data, self).__init__()
        if not train: self.shapes = self.read_classes_ModelNet40()
        self.data, self.labels = self.load_data(f1, f2)
...
class RegistrationData(Dataset):
    def __init__(self, algorithm, data_class=ModelNet40Data(), partial_source=False, partial_template=False,
                 noise=False, additional_params={'use_masknet': False}):
...
if __name__ == '__main__':
    f1 = "/home/i/PycharmProjects/learning3d/data/pcd_data/ply_data_test0_0.pcd"
    f2 = "/home/i/PycharmProjects/learning3d/data/pcd_data/ply_data_test0_1.pcd"
    PcdData(f1, f2, False, 1024, False)
