    ...
    if classifier and pretrained is not None:
        class Network(torch.nn.Module):
            def __init__(self, emb_dims=1024, input_shape="bnc", input_channel_dim=3, classifier=False, num_classes=40,
                ...
                self.pointconv = PointConvDensityClsSsg(emb_dims, input_shape, input_channel_dim, classifier,
                                                        num_classes)
        ...
        class Network(PointConvDensityClsSsg):
            def __init__(self, emb_dims=1024, input_shape="bnc", input_channel_dim=3, classifier=False, num_classes=40,
                         pretrained=None):
                super().__init__(emb_dims=emb_dims, input_shape=input_shape, input_channel_dim=input_channel_dim,
                                 classifier=classifier, num_classes=num_classes, pretrained=pretrained)
