...
def test_one_epoch(device, model, test_loader):
    ...
    print("Mean rotation error: {}, Mean translation error: {} and Mean RMSE: {}".format(np.mean(rotation_errors),
...
def main():
    ...
    trainset = RegistrationData('DeepGMR', ModelNet40Data(train=True),
                                additional_params={'nearest_neighbors': args.nearest_neighbors})
